                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    x.dataDetailKhs.totalSks.toString(),
                                    style: TextStyle(
                                      fontSize: 24,
                                      fontWeight: FontWeight.w700,
                                      color: DataColors.dongker,
                      ...
                      ListView.separated(
                        ...
                        itemCount: x.dataDetailKhs.data.length,
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ConstrainedBox(
                                      ...
                                      child: AutoSizeText(
                                        x.dataDetailKhs.data[index].name,
                                        style: TextStyle(
                                          fontSize: 16,
                                          fontWeight: FontWeight.w700,
                                          color: DataColors.dongker,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          x.dataDetailKhs.data[index].bobot +
                                              " SKS",
                                          style: TextStyle(
                                            fontSize: 12,
                                            fontWeight: FontWeight.w700,
                                ...
                                Container(
                                  ...
                                  child: Align(
                                    alignment: Alignment.center,
                                    child: Text(
                                      x.dataDetailKhs.data[index].nilai,
                                      style: TextStyle(
                                        fontSize: 16,
                                        fontWeight: FontWeight.w700,
                                        color: Colors.white,
              ...
              bottomNavigationBar: Container(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    foregroundColor: DataColors.dongker, // foreground
