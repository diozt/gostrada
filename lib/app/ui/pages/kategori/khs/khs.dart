                      ...
                      return Column(
                        ...
                        children: [
                                    ...
                                    children: [
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "(Semester " +
                                                c.dataMasterKhs.activeSemester +
                                                ")",
                                            style: TextStyle(
                                              fontSize: 13,
                          ...
                          ListView.builder(
                            ...
                            itemCount: c.dataMasterKhs.data.length,
                            itemBuilder: (BuildContext context, int index) {
                              return InkWell(
                                onTap: () {
                                  cont.semester =
                                      c.dataMasterKhs.data[index].semester;
